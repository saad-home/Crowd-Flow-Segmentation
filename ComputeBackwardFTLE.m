...
for i = start_frame - 1  :-1: end_frame
...
t_length = start_frame - end_frame + 1;

T_span  = (start_frame/frame_rate) - (end_frame/frame_rate) + (1/frame_rate);

fprintf('Backward particle advection --- Frame range: %d....%d \n', start_frame, end_frame);
...
fprintf('Computing backward FTLE \n');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
matFTLEFileName = fullfile ( ftle_folder, sprintf('BackwardFTLE%04d-%04d.mat', start_frame, end_frame));
